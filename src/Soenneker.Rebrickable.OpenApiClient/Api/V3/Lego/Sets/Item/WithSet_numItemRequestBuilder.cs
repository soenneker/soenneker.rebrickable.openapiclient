...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.Rebrickable.OpenApiClient.Api.V3.Lego.Sets.Item.WithSet_numItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.Rebrickable.OpenApiClient.Api.V3.Lego.Sets.Item.WithSet_numItemRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
