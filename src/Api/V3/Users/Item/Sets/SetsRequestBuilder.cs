...
namespace Soenneker.Rebrickable.OpenApiClient.Api.V3.Users.Item.Sets
{
    ...
    public partial class SetsRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::Soenneker.Rebrickable.OpenApiClient.Api.V3.Users.Item.Sets.EmptyPathSegmentRequestBuilder EmptyPathSegment
        {
            get => new global::Soenneker.Rebrickable.OpenApiClient.Api.V3.Users.Item.Sets.EmptyPathSegmentRequestBuilder(PathParameters, RequestAdapter);
        }
        ...
        public SetsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v3/users/{user_token}/sets", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.Rebrickable.OpenApiClient.Api.V3.Users.Item.Sets.SetsRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SetsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v3/users/{user_token}/sets", rawUrl)
        {
        }
    }
}
